...
namespace PracticaLista {
    class Materia {
        ...
        int CalificacionPrimerParcial { get; set; }
        int CalificacionSegundoParcial { get; set; }
        int CalificacionTercerParcial { get; set; }
        int CalificacionFinal { get; set; }
        ...
        public Materia(string clave, string nombre, int calificacionPrimerParcial,
                int calificacionSegundoParcial, int calificacionTercerParcial, int calificacionFinal) {
            Clave = clave;
            Nombre = nombre;
